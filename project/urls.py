...
urlpatterns = [
    ...
    url(r'^(?P<slug>[-\w]+)/create_member/$',
        create_member, name='create_member'),

    # ticket status
    url(r'^(?P<slug>[-\w]+)/settings/ticket_status/$',
        ticket_status, name='ticket_status'),
    url(r'^(?P<slug>[-\w]+)/settings/ticket_status/create/$',
        ticket_status_create, name='ticket_status_create'),
    ...
    # priority
    url(r'^(?P<slug>[-\w]+)/settings/priorities/$',
        priorities, name='priorities'),
    url(r'^(?P<slug>[-\w]+)/settings/priority/create/$',
        priority_create, name='priority_create'),
    ...
    # severity
    url(r'^(?P<slug>[-\w]+)/settings/severities/$',
        severities, name='severities'),
    url(r'^(?P<slug>[-\w]+)/settings/severity/create/$',
        severity_create, name='severity_create'),
    ...
    # member roles
    url(r'^(?P<slug>[-\w]+)/settings/member_roles/$',
        member_roles, name='member_roles'),
    url(r'^(?P<slug>[-\w]+)/settings/member_role/create/$',
        member_role_create, name='member_role_create'),
    ...
    url(r'^(?P<slug>[-\w]+)/(?P<milestone_slug>[-\w]+)/task/(?P<task_id>[0-9]+)/$',
        task_details, name="task_details"),

    # comments
    url(r'^(?P<slug>[-\w]+)/task/(?P<task_id>[0-9]+)/comment/$',
