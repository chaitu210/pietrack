...
urlpatterns = [
    ...
    url(r'^comment_delete/(?P<comment_id>[0-9]+)/$', delete_task_comment, name="delete_task_comment"),
    ...
    url(r'^(?P<slug>[-\w]+)/(?P<milestone_slug>[-\w]+)/task/(?P<task_id>[0-9]+)/delete/$', task_delete, name="task_delete"),
    # attachment
